...
def get_parser():
    ...
    parser.add_argument(
        "--eval_batch_size", required=True, type=int, help="Total batch size for eval."
    )
    parser.add_argument(
        "--label_value",
        required=True,
    ...
    parser.add_argument(
        "--K", required=True, type=int, help="Cut-off value for evaluation metrics"
    )
    parser.add_argument(
        "--weight_decay", required=True, type=float, help="L2 regularization term."
    )
    ...
    parser.add_argument(
        "--embed_dim", type=int, help="Nr of dimensions of used word vectors"
    )
    parser.add_argument(
        "--word_hidden",
        type=int,
    ...
    # caps net options
    parser.add_argument("--dim_caps", type=int, help="Nr of dimensions of a capsule")
    parser.add_argument(
        "--num_head_doc", default=5, type=int, help="Nr of dimensions of a capsule"
    )
    parser.add_argument(
        "--num_caps", type=int, help="Number of capsules in Primary Capsule Layer"
    )
    parser.add_argument(
        "--num_compressed_caps", type=int, help="Number of compressed capsules"
    )
    parser.add_argument(
        "--dropout_caps", type=float, help="Dropout to apply within CapsNet"
    )
    parser.add_argument(
        "--lambda_reg_caps", type=float, help="Penalty weight for reconstruction loss"
    )
    parser.add_argument(
        "--KDE_epsilon",
        type=float,
    ...
    parser.add_argument(
        "--ft_lr", type=float, required=False, help="Learning rate to train "
    )
